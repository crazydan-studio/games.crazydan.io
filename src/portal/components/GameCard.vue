    ...
    <div v-if="game.preview === 'pet'" class="preview preview--pet" aria-hidden="true">
      <div class="pet-preview">
        ...
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <g class="pet-body">
            <g class="pet-tail">
              <path d="M148 138 Q186 122 176 82" fill="none" stroke="#B45F1E" stroke-width="11" stroke-linecap="round" />
              <path d="M168 96 q6 10 2 18 M174 82 q4 8 1 14" fill="none" stroke="#4A3728" stroke-width="4" stroke-linecap="round" opacity="0.55" />
            </g>
            <ellipse cx="100" cy="142" rx="43" ry="33" fill="#E88A3A" />
            <ellipse cx="100" cy="152" rx="25" ry="19" fill="#F7E3C8" />
            <path d="M58 58 L66 16 L92 40 Z" fill="#E88A3A" />
            <path d="M142 58 L134 16 L108 40 Z" fill="#E88A3A" />
            <path d="M65 50 L69 28 L83 41 Z" fill="#B45F1E" opacity="0.75" />
            <path d="M135 50 L131 28 L117 41 Z" fill="#B45F1E" opacity="0.75" />
            <circle cx="100" cy="86" r="44" fill="#E88A3A" />
            <path d="M64 96 a44 44 0 0 0 72 0 a40 40 0 0 1 -72 0 Z" fill="#F7E3C8" opacity="0.55" />
            <g class="pet-eyes">
